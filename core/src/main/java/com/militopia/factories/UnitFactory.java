...
public class UnitFactory {
    ...
    // Terrain & Object Regions (Keep existing ones)
    ...
    // ... (Keep getTerrainUi, getObjectUi, getTextureForTerrain, createObjectEntity, UiInfo class unchanged) ...
