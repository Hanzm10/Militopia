...
public class UnitStatConfig {
    ...
    static {
        ...
        m.put(UnitType.TITAN,         new UnitStatData(60,  20,  10,   2,   2,   3,  25,  StatsComponent.MoveType.LAND));
        ...
        m.put(UnitType.WRAITH,        new UnitStatData(30,  25,   3,   4,   3,   4,  25,  StatsComponent.MoveType.AIR));
        ...
        m.put(UnitType.DREADNOUGHT,   new UnitStatData(70,  20,   8,   2,   4,   3,  25,  StatsComponent.MoveType.SEA));
