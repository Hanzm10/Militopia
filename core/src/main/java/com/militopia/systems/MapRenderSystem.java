...
public class MapRenderSystem extends EntitySystem {
    ...
    private final UnitFactory unitFactory; // ADD THIS
    ...
    public MapRenderSystem(SpriteBatch batch, UnitFactory factory, MapGenerator.GameMap map) {
        this.batch = batch;
        this.unitFactory = factory; // USE FACTORY
        this.gameMap = map;
    ...
    // ... (Keep the rest of your methods: renderBordersPass, getIsoCoords, getTileOwner, isBase, drawHighlight) ...
    // Paste them here.
